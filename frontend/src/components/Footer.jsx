...
const Footer = () => {
    ...
    return (
        <footer>
            <div>
                {/* Contenedor principal del grid del footer */}
                <div id="footer-container">
                    
                    {/* Columna 1: Información de la empresa y ubicación */}
                    <div>
                        <h3>Madhouse</h3>       
                        <p id="lema">Estilo, calidad y profesionalismo en cada servicio</p>
                        <div id="ubicacion">
                            {/* SVG: Código matemático que dibuja un ícono vectorial (no pierde calidad al acercar) */}
                        ...
                        {/* Enlace externo tradicional. Usamos target="_blank" para abrir en otra pestaña */}
